...
def load_acm(feat_type=0):
    dl = data_loader('/local/scratch/hcui25/Project/xin/H2H/dataset/ACM')
...
def load_freebase(feat_type=1):
    dl = data_loader('/local/scratch/hcui25/Project/xin/H2H/dataset/Freebase')
...
def load_dblp(feat_type=0):
    prefix = '/local/scratch/hcui25/Project/xin/H2H/dataset/DBLP'
...
def load_LastFM(feat_type=0):
    prefix = '/local/scratch/hcui25/Project/xin/H2H/dataset/LastFM'
    dl = data_loader(prefix)
    print(dl)
    link_type_dic = {0: 'ap', 1: 'pc', 2: 'pt', 3: 'pa', 4: 'cp', 5: 'tp'}
    author_num = dl.nodes['count'][0]
...
def load_imdb(feat_type=0):
    prefix = '/local/scratch/hcui25/Project/xin/H2H/dataset/IMDB'
    dl = data_loader(prefix)
    ...
    test_mask = dl.labels_train['mask'][:movie_num]
    train_valid_mask = dl.labels_test['mask'][:movie_num]
    train_valid_indices = np.where(train_valid_mask == True)[0]
    split_index = int(0.9 * np.shape(train_valid_indices)[0])
    train_indices = train_valid_indices[:split_index]
    valid_indices = train_valid_indices[split_index:]
    train_mask = copy.copy(train_valid_mask)
    valid_mask = copy.copy(train_valid_mask)
